...
AS $$
DECLARE
  project_url TEXT := 'https://yzmzmobbkrxrcyjjuvqo.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl6bXptb2Jia3J4cmN5amp1dnFvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMTUyMzk1OSwiZXhwIjoyMDI3MDk5OTU5fQ.gOtEcLoeHBX-XC3_JfDKtL1tyB0CMse9lZTo2tiNhnw'; -- full access needed for http request to storage
